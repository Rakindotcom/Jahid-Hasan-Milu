...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark text-gray-900 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
          ...
          >
            <div className="flex items-center space-x-4 mb-8">
              ...
              <div>
                <h3 className="text-2xl font-display font-bold text-gray-900">Divine Consultancy</h3>
                <p className="text-gray-800 font-medium">Prophetic Productivity</p>
              </div>
            </div>
            
            <p className="text-gray-900 mb-8 leading-relaxed text-lg max-w-md">
              ...
              {[
                ...
                >
                  <div className="w-10 h-10 glass-light rounded-xl flex items-center justify-center group-hover:bg-white/20 transition-all duration-300">
                    <contact.icon size={18} className="text-blue-700" />
                  </div>
                  <span className="text-gray-900 group-hover:text-gray-900 transition-colors">{contact.text}</span>
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-xl font-display font-bold mb-8 text-gray-900">Quick Links</h4>
            <ul className="space-y-4">
              {quickLinks.map((link, index) => (
                ...
                >
                  <a
                    href={link.href}
                    className="text-gray-800 hover:text-gray-900 transition-all duration-300 text-sm font-medium flex items-center space-x-2 group"
                  >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-xl font-display font-bold mb-8 text-gray-900">Stay Connected</h4>
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-6 py-4 rounded-2xl bg-white border border-gray-300 text-gray-900 placeholder-gray-600 text-sm focus:outline-none focus:border-blue-600 focus:bg-gray-50 transition-all duration-300"
                />
                <motion.button 
                  className="absolute right-2 top-2 bottom-2 bg-blue-600 px-4 rounded-xl hover:bg-blue-500 transition-colors duration-300 flex items-center justify-center text-white"
            ...
            <div>
              <p className="text-gray-800 text-sm mb-4">Follow us:</p>
              <div className="flex space-x-3">
                {socialLinks.map((social, index) => (
                  <motion.a
                    key={index}
                    href={social.href}
                    className="w-10 h-10 glass-light rounded-xl flex items-center justify-center text-gray-800 hover:text-gray-900 transition-all duration-300 hover:bg-gray-100 text-xs font-medium"
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="border-t border-gray-300 mt-16 pt-12"
        >
            ...
            <div className="text-sm text-gray-700 flex items-center space-x-2">
              ...
              by{" "}
                <a
                  ...
                  className="font-semibold text-teal-700 hover:text-teal-900 cursor-pointer transition-colors underline"
                >
                  Rakin Al Shahriar
                </a>
              </p></span>
          ...
          >
            ...
            <p className="text-xs text-gray-700 mt-2 font-medium">- Quran 6:73</p>
          </motion.div>
        </motion.div>
      </div>
    </footer>
